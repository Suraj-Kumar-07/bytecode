            ...
            <section className="mt-[9.8vh] min-h-[90vh] bg-white dark:bg-gray-900">
                <div className='pt-[100px] w-[50%] mx-[25%]' >
                    <form>
                        ...
                        <div className="relative">
                            <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search articles..." required  onChange={onHandleChange}/>
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                        ...
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">The best place to learn data structures, algorithms, and practice coding interview questions, real interview experiences free of cost.</p>
                    </div>
