...
function Contest() {
  ...
  return (
    <div className='mt-[9.8vh] px-[10vw] py-[3vw] dark:bg-gray-900'>
      <h1 class="mb-[4vh] text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">We invest time in <span className='text-red-600 text-6xl font-extrabold'>Contests </span> </h1>
